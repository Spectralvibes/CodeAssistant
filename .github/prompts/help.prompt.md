...
**** (Get Stuff Done) creates hierarchical project plans optimized for solo agentic development with Copilot Code.
...
## Staying Updated
 ...
 evolves fast. Update periodically:
...
- `.github/PROJECT.md` — vision and requirements
- `.github/config.json` — workflow mode (interactive/yolo)
- `.github/research/` — domain research (if selected)
- `.github/REQUIREMENTS.md` — scoped requirements with REQ-IDs
- `.github/ROADMAP.md` — phases mapped to requirements
...
- Creates `.github/codebase/` with 7 focused documents
...
- Generates `./phases/XX-phase-name/XX-YY-PLAN.md`
- Breaks phase into concrete, actionable tasks
- Includes verification criteria and success measures
- Multiple plans per phase supported (XX-01, XX-02, etc.)

Usage: `/plan-phase.md 1`
Result: Creates `./phases/01-foundation/01-01-PLAN.md`
...
- Updates .github/REQUIREMENTS.md, .github/ROADMAP.md, .github/STATE.md
...
**`/quick.md`**
Execute small, ad-hoc tasks with  guarantees but skip optional agents.

Quick mode uses the same system with a shorter path:

- Spawns planner + executor (skips researcher, checker, verifier)
- Quick tasks live in `./quick/` separate from planned phases
- Updates .github/STATE.md tracking (not .github/ROADMAP.md)

Use when you know exactly what to do and the task is small enough to not need research or verification.

Usage: `/quick.md`
Result: Creates `./quick/NNN-slug/PLAN.md`, `./quick/NNN-slug/SUMMARY.md`
...
- Appends to .github/ROADMAP.md
- Uses next sequential number
- Updates phase directory structure

Usage: `/add-phase.md "Add admin dashboard"`

**`/insert-phase.md ## After
...
Mirrors `/new-project.md` flow for brownfield projects (existing .github/PROJECT.md).
...
- Reads .github/STATE.md for project context
...
- Updates .github/STATE.md session continuity section
...
- Creates `./debug/[slug].md` to track investigation
...
- Creates structured todo file in `./todos/pending/`
- Infers area from file paths for grouping
- Checks for duplicates before creating
- Updates .github/STATE.md todo count
...
- Adds gap closure phases to .github/ROADMAP.md
...
`**
Quick switch model profile for  agents.
...
**`/update.md`**
Update  to latest version with changelog preview.
...
```
./
├── .github/PROJECT.md            # Project vision
├── .github/ROADMAP.md            # Current phase breakdown
├── .github/STATE.md              # Project memory & context
├── .github/config.json           # Workflow mode & gates
├── todos/                # Captured ideas and tasks
│   ├── pending/          # Todos waiting to be worked on
│   └── done/             # Completed todos
├── debug/                # Active debug sessions
│   └── resolved/         # Archived resolved issues
├── .github/codebase/             # Codebase map (brownfield projects)
...
Change anytime by editing `.github/config.json`

## Planning Configuration

Configure how planning artifacts are managed in `.github/config.json`:
...
- Only needed when `./` is gitignored and you want project-wide searches to include it
...
- Read `.github/PROJECT.md` for project vision
- Read `.github/STATE.md` for current context
- Check `.github/ROADMAP.md` for phase status
