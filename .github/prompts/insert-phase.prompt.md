...
if [ $# -lt 2 ]; then
  ...
  echo "Usage: /insert-phase.md ## After
...
if [ -f .github/ROADMAP.md ]; then
  ...
  echo "ERROR: No roadmap found (.github/ROADMAP.md)"
  exit 1
fi
```
...
### Step: create_phase_directory


Create the phase directory structure:

```bash
phase_dir="./phases/${decimal_phase}-${slug}"
mkdir -p "$phase_dir"
```
...
Update .github/STATE.md to reflect the inserted phase:

1. Read `.github/STATE.md`
...
- Directory: ./phases/{decimal-phase}-{slug}/
- Status: Not planned yet
- Marker: (INSERTED) - indicates urgent work

Roadmap updated: {roadmap-path}
Project state updated: .github/STATE.md
