...
applyTo: "**/.github/PROJECT.md,**/new-project*"
---
...
By the end of questioning, you need enough clarity to write a .github/PROJECT.md that downstream phases can act on:
...
A vague .github/PROJECT.md forces every downstream phase to guess. The cost compounds.
...
When you could write a clear .github/PROJECT.md, offer to proceed:
