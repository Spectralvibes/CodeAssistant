---
description: "TDD guidelines - when to use test-driven development and how to structure TDD plans"
applyTo: "**/PLAN.md,**/*.test.*,**/*.spec.*"
---
...
2. Write test describing expected behavior (from `## Behavior
