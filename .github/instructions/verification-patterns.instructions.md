...
applyTo: "**/VERIFICATION.md,**/SUMMARY.md"
---
...
{otherData.map(...)}  // Uses different data
```
...
**checkpoints.instructions.md** → `## Automation Reference

` section

Key principles:

- Copilot sets up verification environment BEFORE presenting checkpoints
