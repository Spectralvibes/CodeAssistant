---
description: "Model profile configuration for  agents - quality vs token spend balancing"
applyTo: "**/.github/config.json"
---

# Model Profiles

Model profiles control which Copilot model each  agent uses. This allows balancing quality vs token spend.
...
Per-project default: Set in `.github/config.json`:
