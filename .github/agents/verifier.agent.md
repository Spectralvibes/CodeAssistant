...
Extract phase goal from .github/ROADMAP.md. This is the outcome to verify, not the tasks.
...
If .github/REQUIREMENTS.md exists and has requirements mapped to this phase:
...
Create `./phases/{phase_dir}/{phase}-VERIFICATION.md` with:
...
Structured gaps in VERIFICATION.md frontmatter for `/plan-phase.md --gaps`.
...
**Structure gaps in YAML frontmatter.** The planner (`/plan-phase.md --gaps`) creates plans from your analysis.
...
No messages  // Always shows "no messages"
```
