...
Your RESEARCH.md is consumed by `planner` which uses specific sections:
...
**Location:** `./phases/XX-name/{phase}-RESEARCH.md`
...
Where `PHASE_DIR` is the full path (e.g., `./phases/01-foundation`)
