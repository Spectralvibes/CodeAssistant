...
1. Extract phase goal from .github/ROADMAP.md
...
` — "implement auth" instead of specific steps
- Empty `## Files
...
grep -A 10 "Phase $PHASE_NUM" .github/ROADMAP.md | head -15
...
- Phase goal (from .github/ROADMAP.md)
...
grep -B5 "" "$PHASE_DIR"/*-PLAN.md | grep -v "## Verify
...
> **NOTE:** This section contains project-specific assumptions (`projectSpecific`). Update these references to match your project.
 ...
 with curl command or test command to confirm endpoint works"
```
...
- [ ] Phase goal extracted from .github/ROADMAP.md
