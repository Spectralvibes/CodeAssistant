...
See ~/./templates/discovery.md `## Discovery Protocol
...
6. **Create DISCOVERY.md** using ~/./templates/discovery.md structure:
...
**Output:** `./phases/XX-name/DISCOVERY.md`
...
1. **Scope the discovery** using ~/./templates/discovery.md:
   - Define clear scope
...
6. **Create comprehensive DISCOVERY.md:**
   - Full structure from ~/./templates/discovery.md
...
**Output:** `./phases/XX-name/DISCOVERY.md` (comprehensive)
...
Write `./phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: ./phases/XX-name/DISCOVERY.md
