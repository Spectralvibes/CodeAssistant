---
name: map-codebase
description: Orchestrate parallel codebase mapper agents to analyze codebase and produce structured documents in .github/codebase/ with 7 structured documents.
---
...
Orchestrate parallel codebase mapper agents to analyze codebase and produce structured documents in .github/codebase/
...
Check if .github/codebase/ already exists:

```bash
ls -la .github/codebase/ 2>/dev/null
```

**If exists:**

```
.github/codebase/ already exists with these documents:
[List files found]
...
If "Refresh": Delete .github/codebase/, continue to create_structure
...
Create .github/codebase/ directory:

```bash
mkdir -p .github/codebase
```
...
Write these documents to .github/codebase/:
...
Write this document to .github/codebase/:
...
**Focus:** {focus}
**Documents written:**
- `.github/codebase/{DOC1}.md` ({N} lines)
- `.github/codebase/{DOC2}.md` ({N} lines)
...
```bash
ls -la .github/codebase/
wc -l .github/codebase/*.md
```
...
- Review specific file: `cat .github/codebase/STACK.md`
...
- User offered clear next steps in  style
