...
```bash
find ./phases -name "*-UAT.md" -type f 2>/dev/null | head -5
```
...
Write to `./phases/XX-name/{phase}-UAT.md`
...
```bash
git add "./phases/XX-name/{phase}-UAT.md"
...
- [ ] If issues: plan-checker verifies fix plans
