...
grep -A 5 "Phase ${PHASE_NUM}" .github/ROADMAP.md

# Requirements mapped to this phase
grep -E "^| ${PHASE_NUM}" .github/REQUIREMENTS.md 2>/dev/null
...
**Extract phase goal:** Parse .github/ROADMAP.md for this phase's goal/description. This is the outcome to verify, not the tasks.

**Extract requirements:** If .github/REQUIREMENTS.md exists, find requirements mapped to this phase. These become additional verification targets.


### Step: establish_must_haves
...
1. **State the goal:** Take phase goal from .github/ROADMAP.md
...
<!-- Goal-backward derivation expertise is baked into the verifier agent -->
...
**Check requirements coverage if .github/REQUIREMENTS.md exists.**

```bash
# Find requirements mapped to this phase
grep -E "Phase ${PHASE_NUM}" .github/REQUIREMENTS.md 2>/dev/null
```
...
### Step: identify_human_verification
...
5. **Requirements Coverage:** If .github/REQUIREMENTS.md exists
