...
description: Orchestrate parallel debug agents to investigate UAT gaps and find root causes. Spawns debug agents per gap, collects diagnoses, updates UAT.md.
---
...
Debug files use the `./debug/` path (hidden directory with leading dot).
