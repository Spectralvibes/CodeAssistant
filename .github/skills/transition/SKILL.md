---
name: transition
description: Mark current phase complete and advance to next. Handles progress tracking, .github/PROJECT.md evolution, and phase advancement.
---
...
Mark current phase complete and advance to next. This is the natural point where progress tracking and .github/PROJECT.md evolution happen.
...
cat .github/PROJECT.md 2>/dev/null
```
...
```bash
ls ./phases/XX-current/*-PLAN.md 2>/dev/null | sort
ls ./phases/XX-current/*-SUMMARY.md 2>/dev/null | sort
```
...
```bash
ls ./phases/XX-current/.continue-here*.md 2>/dev/null
```
...
Evolve .github/PROJECT.md to reflect learnings from completed phase.

**Read phase summaries:**

```bash
cat ./phases/XX-current/*-SUMMARY.md
```
...
### Step: update_current_position_after_transition



Update Current Position section in .github/STATE.md to reflect phase completion and transition.
...
### Step: update_project_reference



Update Project Reference section in .github/STATE.md.
...
### Step: review_accumulated_context



Review and update Accumulated Context section in .github/STATE.md.

**Decisions:**

- Note recent decisions from this phase (3-5 max)
- Full log lives in .github/PROJECT.md Key Decisions table
...
- [ ] Recent decisions noted (full log in .github/PROJECT.md)
...
### Step: update_session_continuity_after_transition



Update Session Continuity section in .github/STATE.md to reflect transition completion.
...
### Step: offer_next_phase



**MANDATORY: Verify milestone status before presenting next steps.**

**Step 1: Read .github/ROADMAP.md and identify phases in current milestone**

Read the .github/ROADMAP.md file and extract:
...
**Phase [X+1]: [Name]** — [Goal from .github/ROADMAP.md]
...
- [ ] .github/ROADMAP.md updated with completion status and plan count
- [ ] .github/PROJECT.md evolved (requirements, decisions, description if needed)
- [ ] .github/STATE.md updated (position, project reference, context, session)
